...
export default async function ({ addon, console, msg }) {
  ...
  while (true) {
    ...
    const SA_ICON_URL = addon.self.getResource("../../../images/cs/icon.svg") /* rewritten by pull.js */;
    ...
    addonSettingsImg.src = addon.self.getResource("/open-link.svg") /* rewritten by pull.js */;
